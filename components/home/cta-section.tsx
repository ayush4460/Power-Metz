      ...
      <Container className="relative z-10">
        ...
        <Reveal direction="up" delay={0.2} duration={1}>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 md:gap-6">
            <a href="mailto:support@metzbattery.in" className="w-full sm:w-auto">
              <Button size="lg" className="w-full h-14 px-8 text-base group bg-primary hover:bg-primary/90 text-white transition-all duration-300 rounded-full border-0">
                {primaryBtn}
                <ArrowRight className="ml-2 h-5 w-5 group-hover:translate-x-1 transition-transform duration-300" />
              </Button>
            </a>
            <a href="/powermetx products.pdf" download className="w-full sm:w-auto">
              <Button size="lg" variant="outline" className="w-full h-14 px-8 text-base border-slate-700 bg-transparent text-white hover:bg-white hover:text-slate-900 transition-all duration-300 rounded-full">
                {secondaryBtn}
              </Button>
            </a>
          </div>
