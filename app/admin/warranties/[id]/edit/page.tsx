...
export default function AdminEditWarrantyPage() {
  const { id } = useParams()
  ...
  if (error || !initialData) {
    return (
      <div className="p-8 text-center">
        ...
        <button onClick={() => router.push('/admin/warranties')} className="text-[#F58220] hover:underline">
    ...
    <div className="space-y-6 pb-10">
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6 sm:p-8">
        <WarrantyForm 
          ...
          onSuccess={() => router.push('/admin/warranties')}
          returnUrl="/admin/warranties"
        />
      </div>
    </div>
  )
