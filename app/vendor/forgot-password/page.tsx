  ...
  const leftContent = (
    <div className="w-full max-w-sm mx-auto">
      <div className="mb-10 text-center lg:text-left">
        <H3 className="text-3xl font-extrabold text-slate-800 tracking-tight">Forgot Password</H3>
        <Paragraph className="text-slate-500 mt-2 text-sm font-medium">
          Enter your registered vendor email address to receive a secure password reset link.
        </Paragraph>
      </div>
      <ForgotPasswordForm />
    </div>
